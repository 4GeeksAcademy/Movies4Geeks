...
<button onClick= {e=> navigate("/private")}className="btn bg-light mr-1 br-0 btn-icon" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
